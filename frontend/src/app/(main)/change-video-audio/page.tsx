...
export default function ChangeVideoAudioPage() {
  ...
  return (
    <>
      <div className="container mx-auto max-w-7xl p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-semibold">Change Video Audio</h1>
          <p className="mt-2 text-base text-gray-600">
            Replace the audio of your video with a new track. The video can be
            up to <span className="text-purple-600">3 minutes</span> in length.
          </p>
        </div>
