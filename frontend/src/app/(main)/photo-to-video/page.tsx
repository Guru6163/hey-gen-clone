...
import ChooseVoiceModal, { type Voice } from "~/components/choose-voice-modal";
...
const samplePhotos = [
  {
    ...
    url: "https://public-hey-gen.s3.us-west-1.amazonaws.com/samples/photos/0008.jpg",
  },
  {
    s3Key: "samples/photos/0009.jpg",
    url: "https://public-hey-gen.s3.us-west-1.amazonaws.com/samples/photos/0009.jpg",
  },
  {
    s3Key: "samples/photos/0022.jpg",
    url: "https://public-hey-gen.s3.us-west-1.amazonaws.com/samples/photos/0022.jpg",
  },
];
    ...
    <div className="container mx-auto max-w-7xl p-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-base text-gray-600">
          Turn a single photo and script into a high-quality avatar video using
          an AI portrait model.
        </p>
      </div>
          ...
          {selectedPhotoUrl && !experimentalModel ? (
            ...
            <div className="flex h-full flex-col items-center rounded-xl border-2 border-dashed border-gray-200 bg-gray-50 px-4 pt-8 pb-4">
              ...
              <div className="mt-6 w-full">
                <div className="text-xs text-gray-500">Try a sample photo</div>
        ...
        <div className="flex flex-1 flex-col gap-4">
          ...
          <div className="flex gap-6">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-xs text-gray-700">Experimental model</span>
            </div>
            {experimentalModel && (
              <div className="flex items-center gap-2">
                <Switch
